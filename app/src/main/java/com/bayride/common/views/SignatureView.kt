...
import com.bayride.R.styleable
import com.bayride.common.utils.Bezier
import com.bayride.common.utils.ControlTimedPoints
import com.bayride.common.utils.TimedPoint
...
//    }
    ...
    fun getSignatureBitmap(): Bitmap? {
        ...
        val whiteBgBitmap = originalBitmap?.width?.let {
            Bitmap.createBitmap(
                it, originalBitmap.height, ARGB_8888
            )
        }
        val canvas = whiteBgBitmap?.let { Canvas(it) }
    ...
    fun setSignatureBitmap(signature: Bitmap) {
        try {
            if (isLaidOut()) {
                ...
                val canvas = mSignatureBitmap?.let { Canvas(it) }
